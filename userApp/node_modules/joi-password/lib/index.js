...
function joiPasswordExtendCore(joi) {
    return {
        ...
        messages: {
            ...
            'password.noWhiteSpaces': '{#label} should not contain any white spaces',
